  ...
  if (loading)
    return (
      <div className="flex items-center justify-center min-h-screen bg-[#0a0a0a]">
        <div className="text-[#F59E0B] text-xl animate-pulse">
  ...
  return (
    <div className="space-y-8 p-4 md:p-8 bg-[#0a0a0a] min-h-screen text-[#F3F4F6]">
      ...
      <div>
        ...
        {error && (
          <p className="text-red-500 mt-2 bg-red-500/10 p-2 rounded">{error}</p>
        )}
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-[#1a1a1a] border border-[#1F2937] rounded-lg overflow-hidden hover:border-[#F59E0B] transition min-h-[320px] flex flex-col">
            ...
            <div className="p-6 flex-1 flex flex-col">
              ...
              <Link
                href="/gold"
                className="bg-[#F59E0B] text-black px-4 py-2 rounded hover:bg-[#FBBF24] mt-auto text-center"
              >
                View Details
              </Link>
            </div>
