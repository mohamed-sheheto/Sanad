...
class StockModel:
    ...
    def __init__(self, ticker=None, start_date='2015-01-01', time_steps=60):
        if ticker is None:
            ticker = self.STOCKS["1"][1]  # Default to CIB
        
        self.ticker = ticker
        self.ticker_name = self._get_ticker_name(ticker)
    ...
    @classmethod
    def _get_ticker_name(cls, ticker):
        for _, (name, stock_ticker) in cls.STOCKS.items():
